...
public class FinanceController {
    ...
    public Map<String, Object> getFinanceList(@RequestParam(required = false) Long userId,
        ...
        List<FinanceVO> list = financeService.getFinanceList(userId, paymentStatus, keyword);
    ...
    // http://localhost:8888/finance/order/{orderId}
    @GetMapping("/order/{orderId}")
    public Finance getFinanceByOrderId(@PathVariable Integer orderId) {
        return financeService.getFinanceByOrderId(orderId);
    }
}
